...
if __name__ == '__main__':
    ...
    net.cuda()
    net.load_state_dict(torch.load('./models/baseline-resnet50.pt'))
    # load test data set
    ...
    for i, test_data in enumerate(test_loader, 0):
        ...
        # log the result
        fd = open(record_file, 'a+')
        fd.write(test_dataset.image_name[i].lstrip('test/')+','+str(prediction[0])+'\n')
        fd.close()